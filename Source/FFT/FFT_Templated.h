	...
	return std::vector<std::pair<std::string, std::string>>(
		{
			...
			{ "source_image", T::ColorTextureFormat_to_OpenGL_compute_Image_type<T>(source_texture_format)},
			{ "target_image", T::ColorTextureFormat_to_OpenGL_compute_Image_type<T>(target_texture_format)},
			
			{ "source_image_dimensionality", T::get_texture_dimention<T>()},
			{ "target_image_dimensionality", T::get_texture_dimention<T>()},
